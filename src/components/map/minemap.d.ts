...
declare namespace minemap {
  ...
  interface MineMapEditOps {
    boxSelect: boolean;
    touchEnabled: boolean;
    displayControlsDefault: boolean;
    showButtons: boolean;
  }
  type MineMapEditStyle = {
    style: {
      "textField": string;
      "textColor": string;
      "textSize": number;
      "custom_style": string; // 此参数为string类型
    };
  };

  class edit {
    static init: any;
    init(map: Map, options: MineMapEditOps): edit;
    onBtnCtrlActive(mode: string, style?: MineMapEditStyle);
  }
  ...
  interface KeywordQueryData {
    keywords: string;
    city: string;
  }
  //四维图新POI关键字搜索
  class service {
    static drivingData(data: DrivingData): Promise<AxiosResponse<any>>;
    static placeSearchKeywordData(data: KeywordQueryData): Promise<AxiosResponse<any>>;
    static autocompleteData(data: KeywordQueryData): Promise<AxiosResponse<any>>;
  }
  ...
  export class Marker extends Evented {
    ...
    setOverPop(shouldBeOverPop: boolean): this;
